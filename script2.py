...
def generate(state: MessagesState):
    ...
    system_message_content = (
        ...
        "Only suggest courses offered at Brown"
        "If there aren't any relevent courses, tell the user that none of the courses this Spring match his requirements and they should try next semester"
        "\n\n"
        f"{docs_content}"
    )
